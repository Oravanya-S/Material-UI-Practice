...
const users = [
  {
    name: "Oravanya Sapsrithong",
    company: "Hermann - Klocko",
  ...
  {
    name: "Dana Botsford",
    company: "Aufderhar, Klein and Rodriguez",
  ...
  {
    name: "Roberta Stokes",
    company: "Mertz, Heathcote and Kemmer",
    role: "Leader",
    verified: "No",
    status: "Banned",
    img: "https://duoplanet.com/wp-content/uploads/2023/05/duolingo-avatar-3.png",
...
const rows = users.map((el) =>
  createData(el.name, el.company, el.role, el.verified, el.status, el.img)
);

const BoxStatus = styled(Box)(({ theme }) => ({
